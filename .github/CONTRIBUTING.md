...
You can file new issues by filling out our [new issue form](https://github.com/devCrossNet/cross-platform-cli-template/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/devCrossNet/cross-platform-cli-template/pulls) for an open or closed PR
...
* In GitHub, send a pull request to `cross-platform-cli-template:master`.
...
[GitHub]: https://github.com/devCrossNet/cross-platform-cli-template/issues
